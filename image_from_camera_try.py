...
if __name__ == '__main__':
    ...
    while end_flag == True:
        ...
        # 矩形切り取り
        # rectangle = cv2.getRectSubPix(c_frame, (356, 15), (53, 60))
        rectangle = cv2.getRectSubPix(c_frame, (53, 60),(356 + 26, 15 + 30))


        # フレーム表示
        cv2.imshow(ORG_WINDOW_NAME, c_frame)
        # cv2.imshow(GAUSSIAN_WINDOW_NAME, g_frame)
        # cv2.imshow(GAUSSIAN_WINDOW_NAME, gray)
        cv2.imshow(GAUSSIAN_WINDOW_NAME, rectangle)
